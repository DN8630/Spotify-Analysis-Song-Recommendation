...
<div>
<p style="font-family: times, serif; font-size:11pt; font-style:italic"><b>Presented by - <b>Daya Nayak, Shubham Jha, Maulik Patel</b></p>
...
```{r, echo=FALSE}
datatable(songs_1 %>% filter(track_artist == "Ed Sheeran", track_name == "I Don't Care (with Justin Bieber)"))
...
```{r, echo=FALSE}
datatable(songs_1 %>% filter(cluster_num == 1946, track_artist!= "Ed Sheeran", track_name != "I Don't Care (with Justin Bieber)"))
```
...
```{r, echo=FALSE}
datatable(songs_1 %>% filter(track_artist == "Ella Fitzgerald", track_name == "Jingle Bells"))

```
And Corresponding Suggestions :
```{r, echo=FALSE}
datatable(songs_1 %>% filter(cluster_num == 1293, track_artist!= "Ella Fitzgerald", track_name != "Jingle Bells"))
```
...
```{r, echo=FALSE}
datatable(songs_1 %>% filter(track_artist == "Shawn Mendes", track_name == "Señorita"))


```
And Corresponding Suggestions :
```{r, echo=FALSE}
datatable(songs_1 %>% filter(cluster_num == 3158, track_artist != "Shawn Mendes", track_name != "Señorita"))
```
...
```{r, echo=FALSE}
datatable(songs_1 %>% filter(track_artist == "Ed Sheeran", track_name == "South of the Border (feat. Camila Cabello & Cardi B)"), options = list(pageLength = 10))

```
And Corresponding Suggestions :
```{r, echo=FALSE}
datatable(songs_1 %>% filter(cluster_num == 5214, track_artist != "Ed Sheeran", track_name != "South of the Border (feat. Camila Cabello & Cardi B)"), options = list(pageLength = 10))
```
